...
if args.block_type == 'conv_block':
    ...
    processing_block_type = ConvolutionalProcessingBlock_Batch_Norm
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_Batch_Norm
elif args.block_type = 'conv_block_bn_rc':
    processing_block_type = ConvolutionalProcessingBlock_Batch_Norm_Residual_Connections
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_Batch_Norm_Residual_Connections

...
class ConvolutionalProcessingBlock_Batch_Norm(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_Batch_Norm, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_Batch_Norm(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_Batch_Norm, self).__init__()
...
class ConvolutionalProcessingBlock_Batch_Norm_Residual_Connections(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_Batch_Norm_Residual_Connections, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_Batch_Norm_Residual_Connections(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_Batch_Norm_Residual_Connections, self).__init__()
